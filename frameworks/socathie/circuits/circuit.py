...
def inference(input, circuit):
    ...
    out, remainder = DenseInt(784, 56, 10**18, out, circuit['dense_42_weights'], circuit['dense_42_bias'])
    output['dense_42_out'] = out
    output['dense_42_remainder'] = remainder

    out, remainder = DenseInt(56, 10, 10**18, out, circuit['dense_43_weights'], circuit['dense_43_bias'])
    output['dense_43_out'] = out
    output['dense_43_remainder'] = remainder

    out = ArgMaxInt(out)
    output['dense_43_softmax_out'] = out
