...
uint get_main_input_signal_no() {return 45502;}

uint get_total_signal_no() {return 460243;}

uint get_number_of_components() {return 537;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 118629;}
...
ctx->componentMemory[coffset].inputCounter = 1568;
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + ((0 + (1 * Fr_toInt(&lvar[3]))) + 784)],&signalValues[mySignalStart + ((0 + (1 * Fr_toInt(&lvar[3]))) + 1568)]); // line circom 11
// end load src
...
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 784;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
ctx->componentMemory[coffset].subcomponents = new uint[0];
}
...
{
PFrElement aux_dest = &signalValues[mySignalStart + 785];
// load src
// end load src
...
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 785)];
// load src
Fr_sub(&expaux[1],&lvar[2],&circuitConstants[0]); // line circom 15
Fr_add(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&expaux[1])) + 785)],&signalValues[mySignalStart + ((0 + (1 * Fr_toInt(&lvar[4]))) + 1)]); // line circom 15
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
}
...
uint csoffset = mySignalStart+3921;
for (uint i = 0; i < 1; i++) {
...
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((0 + (1 * Fr_toInt(&lvar[5]))) + 784)];
// load src
// end load src
...
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((0 + (1 * Fr_toInt(&lvar[5]))) + 1568)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((1 * Fr_toInt(&lvar[5])) + 0) + 785)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
matElemMul_0_run(mySubcomponents[cmp_index_ref],ctx);
...
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 44856;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
...
uint aux_create = 0;
int aux_cmp_num = 0+ctx_index+1;
uint csoffset = mySignalStart+44856;
uint aux_dimensions[1] = {56};
for (uint i = 0; i < 56; i++) {
...
while(Fr_isTrue(&expaux[0])){
Fr_lt(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 44800)],&circuitConstants[4]); // line circom 16
...
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[3])) + 0);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + (((1 * Fr_toInt(&lvar[4])) + 0) + 785)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((56 * Fr_toInt(&lvar[4])) + (1 * Fr_toInt(&lvar[3]))) + 784)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
matMul_2_run(mySubcomponents[cmp_index_ref],ctx);
...
Fr_mul(&expaux[2],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 44744)],&circuitConstants[4]); // line circom 24
Fr_add(&expaux[1],&expaux[2],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 44800)]); // line circom 24
Fr_add(&expaux[2],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[3])) + 0)]].signalStart + 0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 44688)]); // line circom 24
...
PFrElement aux_dest = &signalValues[mySignalStart + ((0 + (1 * Fr_toInt(&lvar[3]))) + 0)];
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + ((0 + (1 * Fr_toInt(&lvar[3]))) + 56)],&signalValues[mySignalStart + ((0 + (1 * Fr_toInt(&lvar[3]))) + 112)]); // line circom 11
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
if(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[2])) + 57)];
// load src
Fr_sub(&expaux[1],&lvar[2],&circuitConstants[0]); // line circom 15
Fr_add(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&expaux[1])) + 57)],&signalValues[mySignalStart + ((0 + (1 * Fr_toInt(&lvar[4]))) + 1)]); // line circom 15
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
}
...
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((0 + (1 * Fr_toInt(&lvar[5]))) + 56)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((0 + (1 * Fr_toInt(&lvar[5]))) + 1)]);
}
...
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((0 + (1 * Fr_toInt(&lvar[5]))) + 112)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((1 * Fr_toInt(&lvar[5])) + 0) + 57)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
matElemMul_4_run(mySubcomponents[cmp_index_ref],ctx);
...
ctx->componentMemory[coffset].templateName = "Dense";
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 646;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
...
uint aux_create = 0;
int aux_cmp_num = 0+ctx_index+1;
uint csoffset = mySignalStart+646;
...
while(Fr_isTrue(&expaux[0])){
Fr_lt(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 636)],&circuitConstants[4]); // line circom 16
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template/function " << myTemplateName << " line 16. " <<  "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
{
PFrElement aux_dest = &lvar[4];
...
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[3])) + 0);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + (((1 * Fr_toInt(&lvar[4])) + 0) + 57)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((10 * Fr_toInt(&lvar[4])) + (1 * Fr_toInt(&lvar[3]))) + 56)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
matMul_6_run(mySubcomponents[cmp_index_ref],ctx);
...
Fr_mul(&expaux[2],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 626)],&circuitConstants[4]); // line circom 24
Fr_add(&expaux[1],&expaux[2],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 636)]); // line circom 24
Fr_add(&expaux[2],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[3])) + 0)]].signalStart + 0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[3])) + 616)]); // line circom 24
Fr_eq(&expaux[0],&expaux[1],&expaux[2]); // line circom 24
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template/function " << myTemplateName << " line 24. " <<  "Followed trace of components: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
{
...
ctx->componentMemory[coffset].signalStart = soffset;
ctx->componentMemory[coffset].inputCounter = 45502;
ctx->componentMemory[coffset].componentName = componentName;
ctx->componentMemory[coffset].idFather = componentFather;
ctx->componentMemory[coffset].subcomponents = new uint[58]{0};
}
...
uint csoffset = mySignalStart+50098;
for (uint i = 0; i < 1; i++) {
...
uint csoffset = mySignalStart+402394;
uint aux_dimensions[1] = {56};
for (uint i = 0; i < 56; i++) {
...
uint aux_create = 57;
int aux_cmp_num = 0+ctx_index+1;
uint csoffset = mySignalStart+45512;
for (uint i = 0; i < 1; i++) {
...
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + (((56 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 784)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((56 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 794)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Dense_3_run(mySubcomponents[cmp_index_ref],ctx);
...
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * Fr_toInt(&lvar[0])) + 44688)];
// load src
// end load src
Fr_copy(aux_dest,&circuitConstants[2]);
}
...
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * Fr_toInt(&lvar[0])) + 44744)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 44754)]);
}
// no need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter > 0);
...
uint cmp_index_ref = 0;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * Fr_toInt(&lvar[0])) + 44800)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 44810)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Dense_3_run(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + ((1 * Fr_toInt(&lvar[0])) + 44744)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 44866)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
ReLU_13_run(mySubcomponents[cmp_index_ref],ctx);
...
uint cmp_index_ref = 57;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + (((10 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 56)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + (((10 * Fr_toInt(&lvar[0])) + (1 * Fr_toInt(&lvar[1]))) + 44922)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Dense_7_run(mySubcomponents[cmp_index_ref],ctx);
...
uint cmp_index_ref = 57;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * Fr_toInt(&lvar[0])) + 616)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 45482)]);
}
// no need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter > 0);
...
uint cmp_index_ref = 57;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * Fr_toInt(&lvar[0])) + 626)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 45492)]);
}
// no need to run sub component
ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1;
assert(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter > 0);
...
uint cmp_index_ref = 57;
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + ((1 * Fr_toInt(&lvar[0])) + 636)];
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 45502)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
Dense_7_run(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[57]].signalStart + ((1 * Fr_toInt(&lvar[0])) + 626)]);
}
{
PFrElement aux_dest = &lvar[0];
// load src
